...
import {TotalExperience} from '../../model/about.model';
    ...
    return (
      <div className='my-4 p-2'>
        <div className="position-relative p-3 text-center text-muted bg-body border border-dashed rounded-5">
          <SvgIconComponent className="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Mudit Kaushik - Profile image" preserveAspectRatio="xMidYMid slice" focusable="false">
            <title>Mudit Kaushik</title>
            <defs>
              <clipPath id="profileImage">
                <rect width="100%" height="100%" fill="#777" />
                <text x="50%" y="50%" fill="#777" dy=".3em">Profile Image</text>
              </clipPath>
            </defs>
          ...
          <p className="col-lg-6 mx-auto mb-4 justify-content-start" style={{ fontSize: '18px', fontWeight: 100 }}>
            {TotalExperience} years ago, I embarked on a journey to translate ideas into reality through the power of code.
